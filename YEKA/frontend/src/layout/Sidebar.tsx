...
const navItems = [
  ...
  { to: '/materiales', icon: Layers, label: 'Materiales', roles: ['ADMIN'] },
  { to: '/tipos-arreglo', icon: Layers, label: 'Tipos Arreglo', roles: ['ADMIN'] },
  { to: '/zonas', icon: Layers, label: 'Zonas', roles: ['ADMIN'] },
