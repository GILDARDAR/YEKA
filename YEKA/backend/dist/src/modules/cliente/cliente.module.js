...
const cliente_facade_1 = require("./cliente.facade");
...
exports.ClienteModule = ClienteModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [cliente_dao_1.ClienteDAO, cliente_facade_1.ClienteFacade, cliente_service_1.ClienteService],
        exports: [cliente_service_1.ClienteService, cliente_facade_1.ClienteFacade, cliente_dao_1.ClienteDAO],
    })
], ClienteModule);
