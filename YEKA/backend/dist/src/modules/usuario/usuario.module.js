...
exports.UsuarioModule = UsuarioModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [usuario_dao_1.UsuarioDAO, usuario_facade_1.UsuarioFacade, usuario_service_1.UsuarioService],
        exports: [usuario_service_1.UsuarioService, usuario_facade_1.UsuarioFacade, usuario_dao_1.UsuarioDAO],
    })
], UsuarioModule);
